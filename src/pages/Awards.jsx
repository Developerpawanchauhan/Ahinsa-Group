  ...
  return (
    <>
      <PageHero
        ...
        image="https://images.unsplash.com/photo-1567427017947-545c5f8d16ad?w=1920&q=85&auto=format&fit=crop"
      />
          ...
          <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
            <Reveal>
              <div className="img-zoom aspect-[4/3] overflow-hidden">
                <img src={AWARDS[0].image} alt={AWARDS[0].title} className="w-full h-full object-cover" />
              </div>
            </Reveal>
            <Reveal delay={0.1}>
              <p className="eyebrow">Featured Award &middot; {AWARDS[0].year}</p>
              <h2 className="heading-serif text-fg text-3xl md:text-5xl mt-5">{AWARDS[0].title}</h2>
              <p className="text-gold-700 dark:text-gold-500 uppercase tracking-[0.25em] text-xs mt-4">
                {AWARDS[0].awardedBy}
              </p>
              <div className="gold-divider mx-0 my-6" />
              <p className="text-fg-muted leading-relaxed">{AWARDS[0].description}</p>
