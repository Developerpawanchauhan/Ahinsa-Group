  ...
  return (
    <>
      <PageHero
        ...
        breadcrumb="Contact"
        image="/images/home/backgrounds/Content.jpg"
      />
      ...
      <section className="bg-page-alt border-b border-soft">
        <div className="container-x py-12 grid md:grid-cols-3 gap-6">
          {[
            { icon: Phone, title: 'Call Us', lines: [COMPANY.phone, '+91 76688 52755'] },
            { icon: Mail, title: 'Email Us', lines: [COMPANY.email, 'support@ahinsagroup.in'] },
          ...
          <div className="lg:col-span-3">
            ...
            <Reveal>
              <form onSubmit={handleSubmit} className="mt-10 grid md:grid-cols-2 gap-5">
                ...
                <div className="md:col-span-2">
                  <button type="submit" disabled={isSubmitting || submitted} className="btn-gold disabled:opacity-50">
                    {isSubmitting ? (
                      'Sending...'
                    ) : submitted ? (
                      <>
