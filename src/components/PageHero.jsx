    ...
    <section className="relative h-[70vh] min-h-[420px] flex items-end overflow-hidden">
      <div className="absolute inset-0 bg-ink-900">
        <img
          ...
          loading="eager"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-ink-900/40 via-ink-900/40 to-ink-900" />
      </div>
      <div className="container-x relative pb-16 md:pb-24">
        <div className="max-w-3xl">
          <nav className="flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-gold-500 mb-6">
