        ...
        <div className="container-x flex justify-between items-center h-9">
          <div className="flex items-center gap-4">
            {[
              ...
              const iconMap = { Facebook, Instagram: Instagram, Linkedin, Youtube };
              const Icon = iconMap[social.icon];
              return (
                <a key={i} href={social.href} target="_blank" rel="noopener noreferrer" className="text-ink-400 hover:text-gold-500 transition">
          ...
          <div className="flex items-center gap-6 text-ink-300">
            <a href="tel:+916398730582" className="flex items-center gap-2 hover:text-gold-500 transition">
